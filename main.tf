...
provider "github" {
  # Configuration options
  token = "xxxx_enter_your_tokenx_xxxxx"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name = "XXXXXXXXXXXXXX_enter your pem file_XXXX" #ENTER YOUR PEM
  ...
  user_data = <<-EOF
          ...
          TOKEN="xXXXXXXXXXXenter_your_tokenx_XXXxXXXXXXXXXXXXXx"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/erhankorkut16/bookstore-repo/master/"
          ...
          docker build -t erhankorkut16/bookstoreapi:latest .
          docker-compose up -d
          EOF
